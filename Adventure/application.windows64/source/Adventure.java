...
********************************************/   
  ...
  boolean play_bgm = true, play_battle = false, play_menu = true;
  boolean level_too_low = false, reset = false;
  ...
  public void draw(){
    ...
    switch(room)
    {
      ...
      if(play_bgm){
        ...
        if(battle_bgm.isPlaying()){
        
          battle_bgm.stop();
        }
        
        for(int i = 0; i < boss_bgm.length; i++){
          if(boss_bgm[i].isPlaying()){
             boss_bgm[i].stop();
          }
        }
      ...
      case 82:
        ...
        if(level_too_low){
          text("Your level is too low.", width/2, height / 2);
        }else{
          text("Wrong job equipment.", width/2, height / 2);
        }
        
        break;
      
      //get equipment from safe  
      case 83:
        fill(60,100,100);
        rect(width/2 - 200, height / 2 - 100, 400, 200);
        fill(0, 0, 100);
      ...
      case 90:
        ...
        if(!boss_battle){
          if(battle_bgm.isPlaying() == false){
            battle_bgm.play();
          }
        }else{
          if(boss_bgm[floor-1].isPlaying() == false){
            boss_bgm[floor-1].play();
          }
        }
    ...
    switch(p[releaser].skills.skill[skill_id].dmg_type){
        ...
        case 2:
              if(p[releaser].get_cur_mp() - p[releaser].skills.skill[skill_id].mp_dec >= 0){
                ...
                if(m[mid].buff_round[7] > 0){
                        m[mid].buff_round[7] = 0;        
                    }
                    
                    if(m[mid].buff_round[13]> 0){
                        m[mid].buff_round[13] = 0;        
                    } 
    ...
    case 1:
      ...
      if(skill_used){
        if(battle_list[cur].skills.skill[mob_skill].dmg_type == 3){
          ...
          text(battle_list[cur].name + " dealt " + display_dmg + " to " + p[target].name, width/2, bag.vertical_margin + battle_UI_margin * 13);
        }
      }else{
        text(battle_list[cur].name + " dealt " + display_dmg + " to " + p[target].name, width/2, bag.vertical_margin + battle_UI_margin * 10);
      }
      break;
  }
    ...
    switch(this.id){
      ...
      ******************************/ 
      ...
      case 211:
        ...
        str = 5; con = 5; intel = 5; wis = 5; agi = 0; patk = 5; pdef = 0; matk = 5; mdef = 0; spd = 0; hp = 0; mp = 0;
        break;
      case 212:
        this.name = "Silve Shield";
        str = 10; con = 10; intel = 10; wis = 10; agi = 0; patk = 15; pdef = 0; matk = 15; mdef = 0; spd = 0; hp = 0; mp = 0;
        break;
      case 213:
        this.name = "Holy Shield";
        str = 15; con = 15; intel = 15; wis = 15; agi = 0; patk = 30; pdef = 0; matk = 30; mdef = 0; spd = 0; hp = 0; mp = 0;
        break;
      case 214:
        this.name = "Magic Shield";
        str = 20; con = 20; intel = 20; wis = 20; agi = 0; patk = 50; pdef = 0; matk = 50; mdef = 0; spd = 0; hp = 0; mp = 0;
        break;
      case 215:
        this.name = "Captain America's Shield";
        str = 25; con = 25; intel = 25; wis = 25; agi = 0; patk = 80; pdef = 0; matk = 80; mdef = 0; spd = 0; hp = 0; mp = 0;
        break;
      
      //armour
      case 221:
        this.name = "Old Armour";
        str = 2; con = 2; intel = 2; wis = 2; agi = 0; patk = 0; pdef = 10; matk = 0; mdef = 10; spd = 0; hp = 50; mp = 10;
        break;
      case 222:
        this.name = "Standard Armour";
        str = 4; con = 5; intel = 4; wis = 5; agi = 0; patk = 0; pdef = 20; matk = 0; mdef = 20; spd = 0; hp = 80; mp = 20;
        break;
      case 223:
        this.name = "Cruciform Armour";
        str = 6; con = 9; intel = 6; wis = 8; agi = 0; patk = 0; pdef = 40; matk = 0; mdef = 40; spd = 0; hp = 120; mp = 30;
        break;
      case 224:
        this.name = "Black Dragon Armour";
        str = 8; con = 12; intel = 8; wis = 10; agi = 0; patk = 0; pdef = 60; matk = 0; mdef = 60; spd = 0; hp = 160; mp = 40;
        break;
      case 225:
        this.name = "Archangel's Blessing";
        str = 10; con = 15; intel = 10; wis = 13; agi = 0; patk = 0; pdef = 80; matk = 0; mdef = 90; spd = 0; hp = 210; mp = 50;
        break;
      
      //accessory
      case 231:
        this.name = "Low-Tier Gemstone";
        str = 0; con = 3; intel = 0; wis = 2; agi = 0; patk = 0; pdef = 0; matk = 0; mdef = 0; spd = 0; hp = 20; mp = 20;
        break;
      case 232:
        this.name = "Common Gemstone";
        str = 0; con = 5; intel = 0; wis = 3; agi = 0; patk = 0; pdef = 0; matk = 0; mdef = 0; spd = 0; hp = 30; mp = 30;
        break;
      case 233:
        this.name = "High-Tier Gemstone";
        str = 0; con = 8; intel = 0; wis = 5; agi = 0; patk = 0; pdef = 0; matk = 0; mdef = 0; spd = 0; hp = 40; mp = 40;
        break;
      case 234:
        this.name = "Excellent Gemstone";
        str = 0; con = 11; intel = 0; wis = 7; agi = 0; patk = 0; pdef = 0; matk = 0; mdef = 0; spd = 0; hp = 50; mp = 50;
        break;
      case 235:
        this.name = "Super Rare Gemstone";
        str = 5; con = 15; intel = 5; wis = 10; agi = 0; patk = 0; pdef = 0; matk = 0; mdef = 0; spd = 0; hp = 80; mp = 70;
        break;
      ...
      ******************************/ 
      ...
      case 311:
        this.name = "Old Bow";
        str = 5; con = 0; intel = 5; wis = 0; agi = 10; patk = 30; pdef = 0; matk = 30; mdef = 0; spd = 5; hp = 0; mp = 0;
        break;
      case 312:
        this.name = "Wooden Bow";
        str = 8; con = 0; intel = 8; wis = 0; agi = 14; patk = 50; pdef = 0; matk = 50; mdef = 0; spd = 10; hp = 0; mp = 0;
        break;
      case 313:
        this.name = "Long Bow";
        str = 14; con = 0; intel = 14; wis = 0; agi = 18; patk = 75; pdef = 0; matk = 75; mdef = 0; spd = 15; hp = 0; mp = 0;
        break;
      case 314:
        this.name = "Phathom Bow";
        str = 21; con = 0; intel = 21; wis = 0; agi = 22; patk = 90; pdef = 0; matk = 90; mdef = 0; spd = 20; hp = 0; mp = 0;
        break;
      case 315:
        this.name = "Bow of Wind";
        str = 28; con = 0; intel = 28; wis = 0; agi = 30; patk = 120; pdef = 0; matk = 120; mdef = 0; spd = 30; hp = 0; mp = 0;
        break;
      
      //armour
      case 321:
        this.name = "Old Cloak";
        str = 0; con = 2; intel = 0; wis = 0; agi = 2; patk = 0; pdef = 10; matk = 0; mdef = 20; spd = 0; hp = 30; mp = 0;
        break;
      case 322:
        this.name = "Magic Cloak";
        str = 0; con = 3; intel = 0; wis = 0; agi = 4; patk = 0; pdef = 20; matk = 0; mdef = 30; spd = 0; hp = 40; mp = 0;
        break;
      case 323:
        this.name = "Silver Cloak";
        str = 0; con = 4; intel = 0; wis = 0; agi = 6; patk = 0; pdef = 30; matk = 0; mdef = 40; spd = 0; hp = 60; mp = 0;
        break;
      case 324:
        this.name = "Devil's Cloak";
        str = 0; con = 5; intel = 0; wis = 0; agi = 8; patk = 0; pdef = 40; matk = 0; mdef = 60; spd = 0; hp = 90; mp = 0;
        break;
      case 325:
        this.name = "Elven Cloak";
        str = 0; con = 6; intel = 0; wis = 0; agi = 10; patk = 0; pdef = 60; matk = 0; mdef = 80; spd = 0; hp = 120; mp = 0;
        break;
      
      //accessory
      case 331:
        this.name = "Old Ring";
        str = 3; con = 2; intel = 3; wis = 0; agi = 3; patk = 5; pdef = 0; matk = 5; mdef = 0; spd = 5; hp = 20; mp = 20;
        break;
      case 332:
        this.name = "Speed Ring";
        str = 6; con = 4; intel = 6; wis = 0; agi = 6; patk = 10; pdef = 0; matk = 10; mdef = 0; spd = 10; hp = 30; mp = 30;
        break;
      case 333:
        this.name = "Mysterious Ring";
        str = 9; con = 6; intel = 9; wis = 0; agi = 9; patk = 15; pdef = 0; matk = 15; mdef = 0; spd = 15; hp = 40; mp = 40;
        break;
      case 334:
        this.name = "Purple Dragon Ring";
        str = 12; con = 8; intel = 12; wis = 0; agi = 12; patk = 25; pdef = 0; matk = 25; mdef = 0; spd = 20; hp = 50; mp = 50;
        break;
      case 335:
        this.name = "Wind's Ring";
        str = 15; con = 10; intel = 15; wis = 0; agi = 15; patk = 40; pdef = 0; matk = 40; mdef = 0; spd = 25; hp = 60; mp = 60;
        break;
      ...
      ******************************/ 
      ...
      case 411:
        ...
        str = 6; con = 0; intel = 0; wis = 0; agi = 12; patk = 15; pdef = 0; matk = 0; mdef = 0; spd = 10; hp = 0; mp = 0;
        break;
      case 412:
        this.name = "Common Dagger";
        str = 12; con = 0; intel = 0; wis = 0; agi = 18; patk = 35; pdef = 0; matk = 0; mdef = 0; spd = 20; hp = 0; mp = 0;
        break;
      case 413:
        this.name = "Military Dagger";
        str = 18; con = 0; intel = 0; wis = 0; agi = 24; patk = 65; pdef = 0; matk = 0; mdef = 0; spd = 30; hp = 0; mp = 0;
        break;
      case 414:
        this.name = "Paw Dagger";
        str = 24; con = 0; intel = 0; wis = 0; agi = 30; patk = 100; pdef = 0; matk = 0; mdef = 0; spd = 40; hp = 0; mp = 0;
        break;
      case 415:
        this.name = "Godlike Dagger";
        str = 32; con = 0; intel = 0; wis = 0; agi = 38; patk = 150; pdef = 0; matk = 0; mdef = 0; spd = 50; hp = 0; mp = 0;
        break;
      
      //armour
      case 421:
        this.name = "Mask";
        str = 0; con = 2; intel = 0; wis = 1; agi = 3; patk = 0; pdef = 10; matk = 0; mdef = 10; spd = 10; hp = 40; mp = 0;
        break;
      case 422:
        this.name = "Thief's Mask";
        str = 0; con = 3; intel = 0; wis = 2; agi = 5; patk = 0; pdef = 20; matk = 0; mdef = 20; spd = 20; hp = 70; mp = 0;
        break;
      case 423:
        this.name = "Red Scarf";
        str = 0; con = 5; intel = 0; wis = 3; agi = 8; patk = 0; pdef = 40; matk = 0; mdef = 30; spd = 30; hp = 100; mp = 0;
        break;
      case 424:
        this.name = "Mysterious Scarf";
        str = 0; con = 7; intel = 0; wis = 4; agi = 11; patk = 0; pdef = 60; matk = 0; mdef = 40; spd = 40; hp = 140; mp = 0;
        break;
      case 425:
        this.name = "Kakashi's Mask";
        str = 0; con = 10; intel = 0; wis = 5; agi = 15; patk = 0; pdef = 80; matk = 0; mdef = 60; spd = 50; hp = 180; mp = 0;
        break;
      
      //accessory
      case 431:
        this.name = "Traveller's Shoes";
        str = 5; con = 2; intel = 0; wis = 0; agi = 4; patk = 10; pdef = 0; matk = 0; mdef = 0; spd = 10; hp = 10; mp = 10;
        break;
      case 432:
        this.name = "Iron Secret Boots";
        str = 10; con = 4; intel = 0; wis = 0; agi = 7; patk = 20; pdef = 0; matk = 0; mdef = 0; spd = 20; hp = 20; mp = 20;
        break;
      case 433:
        this.name = "Boots Of Speed";
        str = 15; con = 6; intel = 0; wis = 0; agi = 11; patk = 30; pdef = 0; matk = 0; mdef = 0; spd = 30; hp = 30; mp = 30;
        break;
      case 434:
        this.name = "Secret Boots";
        str = 20; con = 8; intel = 0; wis = 0; agi = 16; patk = 40; pdef = 0; matk = 0; mdef = 0; spd = 40; hp = 40; mp = 40;
        break;
      case 435:
        this.name = "Flying Boots";
        str = 30; con = 10; intel = 0; wis = 0; agi = 22; patk = 50; pdef = 0; matk = 0; mdef = 0; spd = 50; hp = 50; mp = 50;
        break;
      ...
      ******************************/ 
      ...
      case 511:
        ...
        str = 0; con = 0; intel = 6; wis = 3; agi = 0; patk = 0; pdef = 0; matk = 20; mdef = 0; spd = 0; hp = 0; mp = 10;
        break;
      case 512:
        this.name = "Ancient Magic Book";
        str = 0; con = 0; intel = 12; wis = 6; agi = 0; patk = 0; pdef = 0; matk = 40; mdef = 0; spd = 0; hp = 0; mp = 20;
        break;
      case 513:
        this.name = "Magic Clover";
        str = 0; con = 0; intel = 19; wis = 9; agi = 0; patk = 0; pdef = 0; matk = 70; mdef = 0; spd = 0; hp = 0; mp = 30;
        break;
      case 514:
        this.name = "Lucky Clover";
        str = 0; con = 0; intel = 27; wis = 12; agi = 0; patk = 0; pdef = 0; matk = 115; mdef = 0; spd = 0; hp = 0; mp = 40;
        break;
      case 515:
        this.name = "Death Note";
        str = 0; con = 0; intel = 36; wis = 15; agi = 0; patk = 0; pdef = 0; matk = 175; mdef = 0; spd = 0; hp = 0; mp = 50;
        break;
      
      //armour
      case 521:
        this.name = "Old Robe";
        str = 0; con = 2; intel = 3; wis = 2; agi = 0; patk = 0; pdef = 10; matk = 0; mdef = 10; spd = 0; hp = 40; mp = 30;
        break;
      case 522:
        this.name = "Traveller's Robe";
        str = 0; con = 4; intel = 5; wis = 4; agi = 0; patk = 0; pdef = 20; matk = 0; mdef = 20; spd = 0; hp = 60; mp = 60;
        break;
      case 523:
        this.name = "Smurf's Robe";
        str = 0; con = 6; intel = 7; wis = 6; agi = 0; patk = 0; pdef = 30; matk = 0; mdef = 30; spd = 0; hp = 90; mp = 90;
        break;
      case 524:
        this.name = "Mysterious Robe";
        str = 0; con = 8; intel = 9; wis = 8; agi = 0; patk = 0; pdef = 40; matk = 0; mdef = 40; spd = 0; hp = 135; mp = 120;
        break;
      case 525:
        this.name = "Robe Of Hellfire";
        str = 0; con = 10; intel = 12; wis = 10; agi = 0; patk = 0; pdef = 60; matk = 0; mdef = 80; spd = 0; hp = 200; mp = 150;
        break;
      
      //accessory
      case 531:
        this.name = "Common Magic Ball";
        str = 0; con = 2; intel = 3; wis = 2; agi = 0; patk = 0; pdef = 0; matk = 10; mdef = 0; spd = 0; hp = 30; mp = 30;
        break;
      case 532:
        this.name = "Green Magic Ball";
        str = 0; con = 4; intel = 6; wis = 4; agi = 0; patk = 0; pdef = 0; matk = 20; mdef = 0; spd = 0; hp = 60; mp = 60;
        break;
      case 533:
        this.name = "Blue Magic Ball";
        str = 0; con = 6; intel = 9; wis = 6; agi = 0; patk = 0; pdef = 0; matk = 35; mdef = 0; spd = 0; hp = 90; mp = 90;
        break;
      case 534:
        this.name = "Dark Magic Ball";
        str = 0; con = 8; intel = 12; wis = 8; agi = 0; patk = 0; pdef = 0; matk = 50; mdef = 0; spd = 0; hp = 120; mp = 120;
        break;
      case 535:
        this.name = "Infernal Magic Ball";
        str = 0; con = 10; intel = 15; wis = 10; agi = 0; patk = 0; pdef = 0; matk = 70; mdef = 0; spd = 0; hp = 160; mp = 160;
        break;
      ...
      ******************************/ 
      ...
      case 611:
        this.name = "Old Wand";
        str = 0; con = 0; intel = 2; wis = 5; agi = 0; patk = 0; pdef = 0; matk = 20; mdef = 0; spd = 0; hp = 20; mp = 20;
        break;
      case 612:
        this.name = "Wand Of Forest";
        str = 0; con = 0; intel = 4; wis = 10; agi = 0; patk = 0; pdef = 0; matk = 30; mdef = 0; spd = 0; hp = 30; mp = 30;
        break;
      case 613:
        this.name = "Crystal Wand";
        str = 0; con = 0; intel = 7; wis = 15; agi = 0; patk = 0; pdef = 0; matk = 45; mdef = 0; spd = 0; hp = 40; mp = 40;
        break;
      case 614:
        this.name = "Magical Wand";
        str = 0; con = 0; intel = 11; wis = 20; agi = 0; patk = 0; pdef = 0; matk = 60; mdef = 0; spd = 0; hp = 50; mp = 60;
        break;
      case 615:
        this.name = "Poseidon's Triden";
        str = 0; con = 0; intel = 15; wis = 25; agi = 0; patk = 0; pdef = 0; matk = 80; mdef = 0; spd = 0; hp = 75; mp = 80;
        break;
      
      //armour
      case 621:
        this.name = "Worn Robe";
        str = 0; con = 4; intel = 2; wis = 5; agi = 0; patk = 0; pdef = 20; matk = 0; mdef = 20; spd = 0; hp = 40; mp = 30;
        break;
      case 622:
        this.name = "Monk's Robe";
        str = 0; con = 7; intel = 3; wis = 10; agi = 0; patk = 0; pdef = 30; matk = 0; mdef = 30; spd = 0; hp = 80; mp = 50;
        break;
      case 623:
        this.name = "Servant's Robe";
        str = 0; con = 11; intel = 5; wis = 16; agi = 0; patk = 0; pdef = 40; matk = 0; mdef = 40; spd = 0; hp = 120; mp = 80;
        break;
      case 624:
        this.name = "Holy Robe";
        str = 0; con = 15; intel = 8; wis = 23; agi = 0; patk = 0; pdef = 60; matk = 0; mdef = 60; spd = 0; hp = 160; mp = 110;
        break;
      case 625:
        this.name = "Angel's Descent";
        str = 0; con = 20; intel = 12; wis = 30; agi = 0; patk = 0; pdef = 80; matk = 0; mdef = 80; spd = 0; hp = 200; mp = 150;
        break;
      
      //accessory
      case 631:
        this.name = "Gold Necklace";
        str = 0; con = 2; intel = 2; wis = 3; agi = 1; patk = 0; pdef = 5; matk = 10; mdef = 5; spd = 0; hp = 20; mp = 20;
        break;
      case 632:
        this.name = "Crystal Necklace";
        str = 0; con = 4; intel = 4; wis = 6; agi = 2; patk = 0; pdef = 10; matk = 20; mdef = 10; spd = 0; hp = 30; mp = 30;
        break;
      case 633:
        this.name = "Arcane Necklace";
        str = 0; con = 6; intel = 6; wis = 9; agi = 3; patk = 0; pdef = 15; matk = 30; mdef = 15; spd = 0; hp = 40; mp = 40;
        break;
      case 634:
        this.name = "Guardian's Cross";
        str = 0; con = 8; intel = 8; wis = 12; agi = 4; patk = 0; pdef = 20; matk = 45; mdef = 20; spd = 0; hp = 50; mp = 50;
        break;
      case 635:
        this.name = "Millennium Puzzle";
        str = 0; con = 10; intel = 10; wis = 15; agi = 5; patk = 0; pdef = 30; matk = 60; mdef = 30; spd = 0; hp = 60; mp = 60;
        break;
...
class Units{
  ...
  public ArrayList <Integer> skillset = new ArrayList <Integer>();
    ...
    switch(battle_mode){
      ...
      case 10:
        ...
        if(frameCount - start_frame < 100){
                display_damage(def, ((battle_list[cur].get_type() + 1) % 2));
...
class Normal_Skill_1 extends Skill{
  ...
  public Normal_Skill_1(){
    ...
    this.name = monster_skill_name[r.nextInt(2)];
...
class Elite_Skill_7 extends Skill{
  ...
  public void skilldamage(){
    ...
    dmg(this.damage,r.nextInt(100) % c_pt,0);
  }
}
...
class F2_Skill_2 extends Skill{
    ...
    public void skilldamage(){
      ...
      m[mid].inc_matk(m[mid].get_matk() * 0.2f);      
    }
}
